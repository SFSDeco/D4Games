    ...
    <div class="container-fluid">
        ...
        <form class="formstyling" method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                <div class="row-auto">
                    ...
                    <h2 class="h1-white">If you want to change your data
                        you can do this by using the input fields below.
                    </h2>
                    <h3 class="h1-white">
                        Attention! Only correctly filled inputs will be accepted and changed in our Database
                    </h3><br><br>
                </div>
                <div class="row-auto">
                </div>
